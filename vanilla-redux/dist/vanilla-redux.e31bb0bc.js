...
var binIncrease = document.querySelector('#increase');
var binDecrease = document.querySelector('#decrease');
...
function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initilState;
...
binIncrease.onclick = function () {
  store.dispatch(increase(1));
};

binDecrease.onclick = function () {
